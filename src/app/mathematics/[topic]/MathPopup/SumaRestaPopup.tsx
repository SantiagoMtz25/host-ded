...
const SumaRestaPopup: React.FC<SumaRestaPopupProps> = ({ isOpen, onClose }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white p-6 rounded-2xl shadow-md max-w-md w-full mx-3">
        ...
        <div className="max-h-96 overflow-y-auto pr-2">
          ...
          <p className="text-gray-600 mb-4 font-bold">mcd = 12</p>
          <div className="flex justify-center mb-4">
            <Image
          ...
          <p className="text-gray-600 mb-4 ">debido a</p>
          <div className="flex justify-center mb-4">
            <Image
          ...
          <p className="text-gray-600 mb-4">La respuesta es: </p>
