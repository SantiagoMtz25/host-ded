...
const AlgorithmPopup: React.FC<AlgorithmPopupProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white p-6 rounded-2xl shadow-md max-w-md w-full mx-3">
        ...
        <p className="text-gray-600 mb-4">Es el método o procedimiento que se utiliza para ejecutar una operación matemática.</p>
      </div>
    </div>
  );
};
