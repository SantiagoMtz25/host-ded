      ...
      <div className="relative h-56 overflow-hidden rounded-2xl md:h-96">
        {title.map((itemTitle, index) => (
          <>
            <div
              key={index}
              className="flex flex-col gap-6 items-start justify-end px-4 pb-10 pl-16 duration-500 ease-in-out"
              data-carousel-item
              style={{
                backgroundImage: `linear-gradient(90deg, rgba(0,0,0,1) 1%, rgba(145,145,145,0.5) 100%, rgba(255,255,255,0) 100%), url(${imageURL[index]})`,
